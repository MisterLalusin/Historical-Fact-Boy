...
public class prespanisheramultiplechoicesetd002 extends AppCompatActivity {

    private static final String TAG = "prespanisheramultiplechoicesetd002";//score database
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.style_prespanisheramultiplechoicesetd002);
