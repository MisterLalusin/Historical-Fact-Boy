...
public class spanisheramultiplechoicesetc002 extends AppCompatActivity {

    private static final String TAG = "spanisheramultiplechoicesetc002";//score database
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.style_spanisheramultiplechoicesetc002);
