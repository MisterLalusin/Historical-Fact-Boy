...
public class spanisheramultiplechoiceseta001 extends AppCompatActivity {
    ...
    private spanisheramultiplechoiceseta003 mQuestionLibrary = new spanisheramultiplechoiceseta003();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.style_spanisheramultiplechoiceseta001);
        ...
        triviaDialog.setContentView(R.layout.style_spanisheramultiplechoicesetatrivia001);
        triviaDialog.show();
    ...
    private void updateQuestion(){
        ...
        if(mQuestionNumber<mQuestionLibrary.getLength() ){
            ...
            Intent intent = new Intent(getApplicationContext(), spanisheramultiplechoiceseta002.class);
