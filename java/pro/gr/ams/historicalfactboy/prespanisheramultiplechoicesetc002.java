...
public class prespanisheramultiplechoicesetc002 extends AppCompatActivity {

    private static final String TAG = "prespanisheramultiplechoicesetc002";//score database
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.style_prespanisheramultiplechoicesetc002);
