...
public class spanisheramultiplechoicesetd001 extends AppCompatActivity {
    ...
    private spanisheramultiplechoicesetd003 mQuestionLibrary = new spanisheramultiplechoicesetd003();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.style_spanisheramultiplechoicesetd001);
        ...
        triviaDialog.setContentView(R.layout.style_spanisheramultiplechoicesetdtrivia001);
        triviaDialog.show();
    ...
    private void updateQuestion(){
        ...
        if(mQuestionNumber<mQuestionLibrary.getLength() ){
            ...
            Intent intent = new Intent(getApplicationContext(), spanisheramultiplechoicesetd002.class);
