...
public class prespanisheramultiplechoiceseta002 extends AppCompatActivity {

    private static final String TAG = "prespanisheramultiplechoiceseta002";//score database
    ...
    MediaPlayer prespanisherabackgroundmusic002;
    MediaPlayer prespanisherabackgroundmusic003;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.style_prespanisheramultiplechoiceseta002);
        ...
        prespanisherabackgroundmusic002 = MediaPlayer.create(this, R.raw.backgroundsfx002);
        prespanisherabackgroundmusic002.setAudioStreamType(AudioManager.STREAM_MUSIC);
        prespanisherabackgroundmusic002.setLooping(false);
        //prespanisherabackgroundmusic002.start();

        prespanisherabackgroundmusic003 = MediaPlayer.create(this, R.raw.backgroundsfx003);
        prespanisherabackgroundmusic003.setAudioStreamType(AudioManager.STREAM_MUSIC);
        prespanisherabackgroundmusic003.setLooping(false);
        ...
        if(score>=8) { //be proud method ko to //paltan
            ...
            prespanisherabackgroundmusic003.start();
        ...
        addscore = "   " + "YOU GOT" + " " + score + "/10" + " " + "AT PRE-SPANISH ERA";//paltan
    ...
    public void tryagain001(View view) {
        Intent intent = new Intent(getApplicationContext(), prespanisheramultiplechoicerandom001.class);
    ...
    protected void onPause() {
        super.onPause();
        prespanisherabackgroundmusic002.stop();
        //prespanisherabackgroundmusic003.stop();
    }
