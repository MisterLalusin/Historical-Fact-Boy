...
public class spanisheramultiplechoiceseta002 extends AppCompatActivity {

    private static final String TAG = "spanisheramultiplechoiceseta002";//score database
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.style_spanisheramultiplechoiceseta002);
