...
public class spanisheramultiplechoicesetc001 extends AppCompatActivity {
    ...
    private spanisheramultiplechoicesetc003 mQuestionLibrary = new spanisheramultiplechoicesetc003();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.style_spanisheramultiplechoicesetc001);
        ...
        triviaDialog.setContentView(R.layout.style_spanisheramultiplechoicesetctrivia001);
        triviaDialog.show();
    ...
    private void updateQuestion(){
        ...
        if(mQuestionNumber<mQuestionLibrary.getLength() ){
            ...
            Intent intent = new Intent(getApplicationContext(), spanisheramultiplechoicesetc002.class);
