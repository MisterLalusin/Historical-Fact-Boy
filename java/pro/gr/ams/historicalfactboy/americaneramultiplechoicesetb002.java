...
public class americaneramultiplechoicesetb002 extends AppCompatActivity {

    private static final String TAG = "americaneramultiplechoicesetb002";//score database
    ...
    MediaPlayer americanerabackgroundmusic002;
    MediaPlayer americanerabackgroundmusic003;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.style_americaneramultiplechoicesetb002);
        ...
        americanerabackgroundmusic002 = MediaPlayer.create(this, R.raw.backgroundsfx002);
        americanerabackgroundmusic002.setAudioStreamType(AudioManager.STREAM_MUSIC);
        americanerabackgroundmusic002.setLooping(false);
        //americanerabackgroundmusic002.start();

        americanerabackgroundmusic003 = MediaPlayer.create(this, R.raw.backgroundsfx003);
        americanerabackgroundmusic003.setAudioStreamType(AudioManager.STREAM_MUSIC);
        americanerabackgroundmusic003.setLooping(false);
        ...
        if(score>=16) { //be proud method ko to //paltan
            ...
            americanerabackgroundmusic003.start();
        ...
        addscore = "   " + "YOU GOT" + " " + score + "/20" + " " + "AT AMERICAN ERA";//paltan
    ...
    protected void onPause() {
        super.onPause();
        americanerabackgroundmusic002.stop();
        //americanerabackgroundmusic003.stop();
    }
