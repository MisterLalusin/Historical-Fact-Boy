...
public class japaneseeramultiplechoicesetb002 extends AppCompatActivity {

    private static final String TAG = "japaneseeramultiplechoicesetb002";//score database
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.style_japaneseeramultiplechoicesetb002);
