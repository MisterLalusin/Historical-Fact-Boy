...
public class prespanisheramultiplechoicesete002 extends AppCompatActivity {

    private static final String TAG = "prespanisheramultiplechoicesete002";//score database
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.style_prespanisheramultiplechoicesete002);
