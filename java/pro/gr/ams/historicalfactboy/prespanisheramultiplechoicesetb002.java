...
public class prespanisheramultiplechoicesetb002 extends AppCompatActivity {

    private static final String TAG = "prespanisheramultiplechoicesetb002";//score database
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.style_prespanisheramultiplechoicesetb002);
