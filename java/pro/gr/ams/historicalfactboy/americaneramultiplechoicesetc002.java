...
public class americaneramultiplechoicesetc002 extends AppCompatActivity {

    private static final String TAG = "americaneramultiplechoicesetc002";//score database
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.style_americaneramultiplechoicesetc002);
