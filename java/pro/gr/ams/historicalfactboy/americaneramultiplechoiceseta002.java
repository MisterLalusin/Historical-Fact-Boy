...
public class americaneramultiplechoiceseta002 extends AppCompatActivity {

    private static final String TAG = "americaneramultiplechoiceseta002";//score database
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.style_americaneramultiplechoiceseta002);
