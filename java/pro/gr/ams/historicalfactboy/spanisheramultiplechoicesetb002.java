...
public class spanisheramultiplechoicesetb002 extends AppCompatActivity {

    private static final String TAG = "spanisheramultiplechoicesetb002";//score database
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.style_spanisheramultiplechoicesetb002);
